...
if (isset($_GET['search']) && isset($_GET['submit'])) {
    ...
    $qurey = "SELECT * FROM posts WHERE title LIKE '%$search%'  ORDER BY date_time DESC";
            ...
            <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                <article class="post">
                    ...
                    <div class="post__info">
                        ...
                        ?>
                        <a href="<?= ROOT_URL ?>post.php?id=<?= $post['category_id'] ?>" class="category__button"><?= $category['title'] ?></a>
                        <h3 class="post__title"><a href="post.php"><?= $post['title'] ?></a></h3>
