...
$featured_result = mysqli_query($connetion, $featured_query);
$featured = mysqli_fetch_assoc($featured_result);
//    fecth 9 posts from posts table 
$qurey = "SELECT * FROM posts ORDER BY date_time DESC LIMIT 9";
...
<?php endif ?>
<section class="posts  section__extra-margin <?= $featured ?'': '' ?>">
